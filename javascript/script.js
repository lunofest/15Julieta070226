...
function updateTimer() {
  const targetDate = new Date("february 7, 2026 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543883131524'; // Número para el primer botón
  const phoneNumber2 = '543883316206'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543883316206'; // Número para el primer botón
  const recipientNumber2 = '543883131524'; // Número para el segundo botón
